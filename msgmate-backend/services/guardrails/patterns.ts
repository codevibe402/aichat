 ...
 * These patterns are designed to be simple and effective for v1.
 */
...
export const SECURITY_PATTERNS: SecurityPattern[] = [
  // Task override attempts — trying to make the AI ignore previous instructions
  {
...
// ── Strict patterns (enabled only in strict mode) ─────────────────────────────
...
// ── Utility: pattern selection ────────────────────────────────────────────────

/** Returns security patterns based on the strictness level. */
...
// ── Tags to preserve during sanitization ─────────────────────────────────────

/** Tag names that are wrapped-content markers and should be preserved. */
...
/**
 * Checks if a tag should be preserved during sanitization.
 * @param tag - The tag to check (e.g., "<nano_user_request>")
 */
